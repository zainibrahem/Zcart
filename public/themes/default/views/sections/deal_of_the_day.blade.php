                                    ...
                                    <div class="week-deal__inner">
                                        ...
                                        <div class="week-deal__details">
                                            ...
                                            <div class="week-deal__details-price">
                                                <p>
                                                    <span class="regular-price"> {!! get_formated_price($deal_of_the_day->current_sale_price(), config('system_settings.decimals', 2)) !!}</span>
                                                    <span class="old-price"> {!! get_formated_price($deal_of_the_day->sale_price, config('system_settings.decimals', 2)) !!}</span>
                                                </p>
                                            </div>
                            ...
                            <div class="best-deal__col">
                                ...
                                <div class="best-seller">
                                    <div class="best-seller__slider best-seller-slider">
                                        @include('theme::partials._product_vertical', ['products' => get_featured_items()])
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="neckbands__inner">
                    ...
                    <div class="neckbands__items">
                        <div class="neckbands__items-inner">
                            @include('theme::partials._product_horizontal', ['products' => get_featured_items()])
                        </div>
                    </div>
                </div>
            </div>

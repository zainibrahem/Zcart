					        ...
					        <div class="col-sm-3 nopadding-left">
								...
								<div class="text-center">
									...
									@if($system->primaryAddress)
										...
										<a href="javascript:void(0)" data-link="{{ route('address.edit', $system->primaryAddress->id) }}"  class="btn btn-default ajax-modal-btn"><i class="fa fa-map-marker"></i> {{ trans('app.update_address') }}</a>
									@else
										<a href="javascript:void(0)" data-link="{{ route('address.create', ['system', $system->id]) }}"  class="btn btn-default ajax-modal-btn"><i class="fa fa-plus-square-o"></i> {{ trans('app.add_address') }}</a>
									@endif
		            ...
		            @if(Auth::guard('web')->user()->isSuperAdmin())
				    	<div class="row">
					    	<div class="col-sm-4 text-center">
					    		<a href="javascript:void(0)" data-link="{{ route('admin.setting.system.modifyEnvFile') }}" class="ajax-modal-btn btn btn-default btn-lg ">{{ trans('app.modify_environment_file') }}</a>
					    		<div class="spacer10"></div>
					    		<p class="text-danger"><i class="fa fa-exclamation-triangle"></i> {!! trans('messages.modify_environment_file') !!}</p>
					    	</div><!-- /.col-sm-4 -->

					    	<div class="col-sm-4 text-center">
					    		<a href="javascript:void(0)" data-link="{{ route('admin.setting.system.importDemoContents') }}" class="ajax-modal-btn btn btn-default btn-lg ">{{ trans('app.import_demo_contents') }}</a>
					    		<div class="spacer10"></div>
					    	...
					    	<div class="col-sm-4 text-center">
					            ...
					            @endif
					    		<div class="spacer10"></div>
					    		<p class="text-info"><i class="fa fa-info-circle"></i> {!! trans('messages.take_a_backup') !!}</p>
					    	</div><!-- /.col-sm-4 -->
				    	</div><!-- /.row -->
				    	...
				    	<div class="row">
				            @unless( config('app.demo') == true )
						    	...
						    	<div class="col-sm-4 text-center">
						    		<a href="{{ route('admin.incevio.clear') }}" class="btn btn-default btn-lg confirm">{{ trans('app.clear_configs') }}</a>
						    		<div class="spacer10"></div>
						    		<p class="text-danger"><i class="fa fa-info-circle"></i> {!! trans('help.help_clear_configs') !!}</p>
						    	</div><!-- /.col-sm-4 -->

						    	<div class="col-sm-4 text-justify">
						    		<a href="javascript:void(0)" data-link="{{ route('admin.setting.license.uninstall') }}" class="ajax-modal-btn btn btn-danger btn-lg ">{{ trans('app.uninstall_app_license') }}</a>
						    		<div class="spacer10"></div>
